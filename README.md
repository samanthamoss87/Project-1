...
- People who have a interest in Video telematics, Telematics, Automotive and OEM.
- Businesses who want to grow and expand their business.
- Businesses who are needing help to meet there sales targets.
...
## Icons
 - [Link to icons8](https://icons8.com/)
        ...
        - This is also where i got my logo's in my flex-boxes on my main page.  
...
- Anything below 768px will show this format using mediaqueries.
...
- I didnt want to much content on the Index page to make it more enxxxxx to click through the site to read more content.
- Making the boxes enlarged when you hover over them was for design but also practicality as it enlargers the words.
- I used the Icons instead of photos to on the flexboxes to help with the performance of the site.
- The Icons was used to make each box more easier to determine where the link is taking you. 
...
- Service page is a really important page for the user to understand what we offer.
...
- I also created the information in the flex boxes so it highlight the specific area for them to review.
...
- I decided not to use images on this page as i didnt want to take away from the content and the design itself still made the style look nice.
...
<div align="center"> 
 ...
 - When Javascript is added to this website, they will also be a popup that the users have to accepted or decline when entering the website.
...
- The next step would be each on of them will work as its on individual app on a phone, so exsiting customer can click on their specific area and it will create a login option so they can log into their account.
...
- Once i have leart Jarascript i will adding a pop up Cookie section once you are in the page. That the customer will have to accept or decline.
